...
* To see which packages are currently available, use the command:
  `module avail`
* To load a module, for example Matlab r2015a, use the command:
  `module load matlab-r2015a`
* To view your loaded modules, use the command:
  `module list`
* To unload a module if you would like to use a different version, for example unloading Matlab r2015a, use the command:
  `module unload matlab-r2015a`
